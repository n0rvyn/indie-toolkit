...
- [ ] Step 2 contains "Deletion-test screen" paragraph referencing ${CLAUDE_PLUGIN_ROOT}/references/deep-modules-pattern.md; Rules section contains "Deletion-test mandatory" bullet
