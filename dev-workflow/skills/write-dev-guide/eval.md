...
- [ ] Phase Splitting Principles section contains "Module-shape lens" bullet referencing ${CLAUDE_PLUGIN_ROOT}/references/deep-modules-pattern.md, with the seam-and-locality reasoning intact and declarative-UI caveat
