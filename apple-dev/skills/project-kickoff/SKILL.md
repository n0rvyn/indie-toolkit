...
完成后，DESIGN.md 与 DesignSystem.swift 的一致性由 `/review-execution` 在 View 变更时派发的 `apple-dev:ui-reviewer` 兑现（判据：`${CLAUDE_PLUGIN_ROOT}/references/design-contract-schema.md`）。双向同步工具 `sync-design-md` 已于 2026-09-04 退役，理由见 `docs/12-retired/sync-design-md.md`。
