...
- [ ] Step 3 contains 5th evaluation question on module shape (deep/shallow + seam/adapter), referencing ${CLAUDE_PLUGIN_ROOT}/references/deep-modules-pattern.md; Output section includes "module-shape note" requirement per option
