...
MD
mkdir -p "$HOME/Obsidian/PKOS/10-Knowledge"
cat > "$HOME/Obsidian/PKOS/10-Knowledge/axolotl-regeneration-notes.md" <<'MD'
# Axolotl regeneration notes
Vault-only note: axolotl limb regeneration depends on nerve signalling.
MD
