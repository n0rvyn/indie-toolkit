...
Read `${CLAUDE_PLUGIN_ROOT}/references/refactoring-ui-distilled.md` Section D (Personality Framework). The 6 dimensions and example values come from this section.
...
Format:
    ...
    ## Source
    - Methodology: ${CLAUDE_PLUGIN_ROOT}/references/refactoring-ui-distilled.md Section D
